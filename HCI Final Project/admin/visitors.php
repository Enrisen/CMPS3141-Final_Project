...
$guards_json = file_get_contents('../json/administrators.json');
$guards_data = json_decode($guards_json, true)['Administrators'];
    ...
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <div class="bottom-buttons-container">
                <a href="adminHome.php" class="btn btn-primary mb-4 bottom-nav back-btn">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-secondary">Security Guard </p>
                            </div>
                            <div class="row g-3">
                                <div class="col-6">
                                    <p class="mb-1 text-secondary">Amdin ID</p>
